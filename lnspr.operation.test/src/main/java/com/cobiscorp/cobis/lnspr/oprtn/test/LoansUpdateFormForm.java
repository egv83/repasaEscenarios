...
public class LoansUpdateFormForm{
	...
	private LoansUpdateFormForm() {
		throw new IllegalStateException("LoansUpdateFormForm is a utility class");
	}
	public static class Layouts {
		...
		public static final LytViewContainerBaseIdVCFYBXCEVKJK907908 lytViewContainerBaseIdVCFYBXCEVKJK907908 = Singleton.getInstance(LytViewContainerBaseIdVCFYBXCEVKJK907908.class);
		
		public static class LytViewContainerBaseIdVCFYBXCEVKJK907908 extends COBISTab {
			public LytViewContainerBaseIdVCFYBXCEVKJK907908(){
				this.init("VC_FYBXCEVKJK_907908", "Información General");
			}
		}
		
		public static final LytViewContainerBaseIdVCCZFQNEQAQF253908 lytViewContainerBaseIdVCCZFQNEQAQF253908 = Singleton.getInstance(LytViewContainerBaseIdVCCZFQNEQAQF253908.class);
		
		public static class LytViewContainerBaseIdVCCZFQNEQAQF253908 extends COBISTab {
			public LytViewContainerBaseIdVCCZFQNEQAQF253908(){
				this.init("VC_CZFQNEQAQF_253908", "Rubros");
			}
		}
		
		public static final LytViewContainerBaseIdVCSLGEFSJAUA161908 lytViewContainerBaseIdVCSLGEFSJAUA161908 = Singleton.getInstance(LytViewContainerBaseIdVCSLGEFSJAUA161908.class);
		
		public static class LytViewContainerBaseIdVCSLGEFSJAUA161908 extends COBISTab {
			public LytViewContainerBaseIdVCSLGEFSJAUA161908(){
				this.init("VC_SLGEFSJAUA_161908", "Parámetros Generales");
			}
		}
		
		public static final LytViewContainerBaseIdVCUTMLTUSZMJ714908 lytViewContainerBaseIdVCUTMLTUSZMJ714908 = Singleton.getInstance(LytViewContainerBaseIdVCUTMLTUSZMJ714908.class);
		
		public static class LytViewContainerBaseIdVCUTMLTUSZMJ714908 extends COBISTab {
			public LytViewContainerBaseIdVCUTMLTUSZMJ714908(){
				this.init("VC_UTMLTUSZMJ_714908", "Amortización");
			}
		}
	...
	public static class Buttons {
		...
		public static final CmdCommand1IdCMTLNSPRVJ776 cmdCommand1IdCMTLNSPRVJ776 = Singleton.getInstance(CmdCommand1IdCMTLNSPRVJ776.class);
		
		public static class CmdCommand1IdCMTLNSPRVJ776 extends COBISButton{
			public CmdCommand1IdCMTLNSPRVJ776 () {
				this.init("CM_TLNSPRVJ_776", "Transmitir");
			}
		}
